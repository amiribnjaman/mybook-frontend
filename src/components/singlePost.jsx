...
export default function singlePost({
  ...
  return (
    <div className="w-[90%] md:w-[80%] mx-auto text-white relative">
      ...
      {/* Body */}
      {Object.keys(post).length > 0 ? (<div className="flex gap-[80px] relative">
        {/* Single Post Content */}
        <div className="w-[55%] mt-[12px] bg-[#203a43] border border-[#2c5364] px-[20px] py-[24px] mb-[20px] rounded-[16px]">
          ...
          <div>
            {/* POST HEADING */}
            {post?.postTitle && (
              <h1 className="text-[24px] my-[16px] font-regular">
                {post?.postTitle}
              </h1>
            )}
            ...
            {/* Post Image */}
          {post?.postImgUrl && (<div className="w-full h-[200px] md:h-[280px] h-full rounded-[12px] md:rounded-[20px] flex items-center justify-center bg-[#203A43] mt-[12px] md:mt-[24px]">
            <img
