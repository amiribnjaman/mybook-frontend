            ...
            <div className="">
              ...
              <div className="my-[32px] grid grid-cols-6 gap-8">
                <div className="col-span-4">
                  ...
                  <p className="mt-[28px] text-[14px] font-light text-[#ddd]">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <div className="">
              ...
              <div className="my-[32px] grid grid-cols-6 gap-8">
                <div className="col-span-4">
                  ...
                  <p className="mt-[28px] text-[#ddd] text-[14px] font-light">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Necessitatibus maiores, laudantium atque illo neque ea
                    facilis sit aliquam omnis animi reiciendis cumque inventore
                    quas explicabo veritatis sunt corporis consequuntur
                    iure.cumque inventore quas explicabo veritatis sunt corporis
                    consequuntur iure.
                  </p>
                </div>
            ...
            <div className="">
              ...
              <div className="my-[32px] grid grid-cols-6 gap-8">
                <div className="col-span-4">
                  ...
                  <p className="mt-[28px] text-[15px] font-light text-[#ddd]">
                    ...
                    আরও আকর্ষণীয় দেখাবে। ব্যবহারকারীরা আরও সুন্দরভাবে কমেন্ট
                    করতে পারবে এবং তাদের ফিড আরও আকর্ষণীয় দেখাবে।
                  </p>
                </div>
