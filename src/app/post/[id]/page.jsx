...
export default function Post() {
  return (
    <div className="w-[90%] md:w-[80%] mx-auto text-white relative">
      {/* Home return button */}
      <Link href="/">
        <div className="bg-[#203A43] w-[100px] h-[44px] flex justify-center items-center rounded-[8px] mb-4 mt-[30px]">
          ...
          <span className="text-[#ddd] text-[14px]">Home</span>
        </div>
      </Link>
      {/* Body */}
      <div className="flex gap-[80px] relative">
        {/* Single Post Content */}
        <div className="w-[55%] mt-[20px] bg-[#203a43] border border-[#2c5364] px-[20px] py-[24px] mb-[20px] rounded-[16px]">
          {/* Post content */}
          <div>
            {/* POST HEADING */}
            ...
            {/* Post Image */}
            <div className="w-full h-[200px] md:h-[240px] h-full rounded-[12px] md:rounded-[20px] flex items-center justify-center bg-[#203A43] mt-[12px] md:mt-[24px]">
              {/* <img
          ...
          /> */}
            ...
            <p className="md:mt-[28px] mt-[20px] text-[18px] font-regular text-[#ddd]">
              ...
              fugit laudantium ea officiis! Repellat, ut. Ea soluta magni fuga
              voluptatibus quibusdam suscipit maxime amet. Quidem, aliquam.
              Minus alias illum pariatur esse, modi sunt facere sequi, harum
              atque, repellat distinctio! Ea! Lorem ipsum, dolor sit amet
              consectetur adipisicing elit. Dolor fugit laudantium ea officiis!
              Repellat, ut. Ea soluta magni fuga voluptatibus quibusdam suscipit
              maxime amet. Quidem, aliquam. Minus alias illum pariatur esse,
              modi sunt facere sequi, harum atque, repellat distinctio! Ea!
            </p>
          </div>
          ...
          <div className="w-[100%] shadow relative">
            <form action="">
              <textarea
                id="postContent"
                rows={2}
                className="rounded-[8px] px-[16px] py-2 block w-full mt-[4px] mb-[10px] md:mb-[16px] focus:border-[#00CFFF] focus:ring-1 focus:ring-[#00CFFF] border border-[#00CFFF] shadow-lg text-black placeholder:font-light outline-none resize-none"
                placeholder="write your comment..."
              />

              <button
                type="submit"
                className="bg-[#00CFFF] text-center text-white text-lg font-regular rounded-[4px] px-4 py-2 md:mt-6 mt-3 mb-2 md:mb-3 absolute bottom-[3px] md:bottom-[0px] right-2 md:right-2"
              >
                comment
              </button>
            </form>
        ...
        <div className="w-[32%] mt-[20px] px-[16px] ml-auto py-[20px] rounded-[16px] fixed right-[10%] bg-[#203a43] border border-[#2c5364] overflow-y-auto h-[80vh]">
